...
namespace IocBattle.Benchmark.Tests
{
    public class AutoFacLambdaContainer : IContainer
    {
        ...
        public void SetupForSingletonTest()
        {
            ...
            builder.Register(c => new WebService(c.Resolve<IAuthenticator>(), c.Resolve<IStockQuote>()))
                .As<IWebService>()
                .SingleInstance();
            builder.Register(
                c => new Authenticator(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>(), c.Resolve<IDatabase>()))
            ...
            builder.Register(
                ...
                .As<IStockQuote>()
                .SingleInstance();
            builder.Register(c => new Database(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>()))
                .As<IDatabase>()
                .SingleInstance();
            builder.Register(c => new ErrorHandler(c.Resolve<ILogger>())).As<IErrorHandler>().SingleInstance();

            builder.Register(c => new Service1(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>()))
                .As<IService1>()
                .SingleInstance();
            builder.Register(c => new Service2(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>()))
                .As<IService2>()
                .SingleInstance();
            builder.Register(c => new Service3(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>()))
                .As<IService3>()
                .SingleInstance();
            builder.Register(c => new Service4(c.Resolve<ILogger>(), c.Resolve<IErrorHandler>()))
                .As<IService4>()
                .SingleInstance();
