    ...
    public class WindsorContainer : IContainer
    {
        ...
        public void Setup(LifestyleType lifestyle)
        {
            ...
            if (lifestyle != LifestyleType.Transient)
            {
                ...
                _container.Register(
                    Component.For<UserController>().ImplementedBy<UserController>().LifeStyle.Is(lifestyle));

                _container.Register(Component.For<IWebService>().ImplementedBy<WebService>().LifeStyle.Is(lifestyle));
                _container.Register(
                    Component.For<IAuthenticator>().ImplementedBy<Authenticator>().LifeStyle.Is(lifestyle));
            ...
            {
                _container.Register(
                    Component.For<IRepository>().ImplementedBy<Repository>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IAuthenticationService>()
                        .ImplementedBy<AuthenticationService>()
                ...
                _container.Register(
                    Component.For<IWebService>().ImplementedBy<WebService>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IAuthenticator>()
                        .ImplementedBy<Authenticator>()
                        .LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IStockQuote>().ImplementedBy<StockQuote>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IDatabase>().ImplementedBy<Database>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                ...
                _container.Register(
                    Component.For<IService1>().ImplementedBy<Service1>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IService2>().ImplementedBy<Service2>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IService3>().ImplementedBy<Service3>().LifestyleCustom<NoTrackLifestyleManager>());
                _container.Register(
                    Component.For<IService4>().ImplementedBy<Service4>().LifestyleCustom<NoTrackLifestyleManager>());

                _container.Register(
                    Component.For<ILogger>().ImplementedBy<Logger>().LifestyleCustom<NoTrackLifestyleManager>());
            }
        }
