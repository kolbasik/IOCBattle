    ...
    public class NewContainer : IContainer
    {
            ...
            where T : class
        {
            if (_isInTransientMode)
                return
                    new WebService(
                        new Authenticator(new Logger(), new ErrorHandler(new Logger()),
                            new Database(new Logger(), new ErrorHandler(new Logger()))),
                        new StockQuote(new Logger(), new ErrorHandler(new Logger()),
                            new Database(new Logger(), new ErrorHandler(new Logger())))) as T;
